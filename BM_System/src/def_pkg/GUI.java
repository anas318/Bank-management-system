...
public class GUI {
	...
	public void openSignInForm(JFrame frame, Login_Account user) {
		...
		btn_SignIn.setForeground(Color.green);
	...
	void open_Signup_form_1(JFrame frame, Login_Account user)
	{
		...
		btn_Verify_Account.setForeground(Color.green);
	...
	void open_Signup_form_2(JFrame frame, Login_Account user, String acc_num)
	{
			...
			btn_create_login_Account.setForeground(Color.green);
	...
	void openClientMenu(JFrame frame, Client client, Bank_Account account) {
		...
		btnAccInfo.setForeground(Color.green);
		f.add(btnAccInfo);
		...
		btnCCWithdrawal.setForeground(Color.green);
		...
		btnTransferMoney.setForeground(Color.green);
		...
		btnEStatement.setForeground(Color.green);
		f.add(btnEStatement);
		...
		btnChangePass.setForeground(Color.green);
		f.add(btnChangePass);
	...
	void open_info_page(JFrame frame, Client client, Bank_Account account)
	{
		...
		btn_sign_out.setForeground(Color.green);
	...
	void open_cardless_page_1(JFrame frame, Client client, Bank_Account account)
	{
		...
		btn_create_cardless_entry.setForeground(Color.green);
		...
		btn_mm.setForeground(Color.green);
	...
	void openTransferMoneyForm(JFrame frame, Client client, Bank_Account account) {
		...
		btn_Transfer.setForeground(Color.green);
	...
	void eStatement2(JFrame frame, Client client, Bank_Account account) {
		...
		btnMM.setForeground(Color.green);
	...
	void open_change_password_form(JFrame frame, Client client, Bank_Account account)
	{
		...
		btn_change_password.setForeground(Color.green);
	...
	void openManagerMenu(JFrame frame, Manager manager) {
		...
		btnCreateAcc.setForeground(Color.green);
		f.add(btnCreateAcc);
		...
		btnBlockAcc.setForeground(Color.green);
		f.add(btnBlockAcc);
		...
		btnCloseAcc.setForeground(Color.green);
		f.add(btnCloseAcc);
		...
		btnSearchAcc.setForeground(Color.green);
		f.add(btnSearchAcc);
		...
		btnManageCard.setForeground(Color.green);
		f.add(btnManageCard);
		...
		btnUpdateInfo.setForeground(Color.green);
		f.add(btnUpdateInfo);
	...
	public void openCreateAccountForm(JFrame frame, Manager manager) {
		...
		btn_create.setForeground(Color.green);
	...
	void open_manage_card_page(JFrame frame, Manager manager)
	{
		...
		btn_block_card.setForeground(Color.green);
		...
		btn_unblock_card.setForeground(Color.green);
	...
	void open_block_unblock_account_page(JFrame frame, Manager manager)
	{
		...
		btn_block_account.setForeground(Color.green);
		...
		btn_unblock_account.setForeground(Color.green);
	...
	void open_close_account_page(JFrame frame, Manager manager)
	{
		...
		btn_close_account.setForeground(Color.green);
	...
	void openAccountantMenu(JFrame frame, Accountant accountant) {
		...
		btnChequeDeposit.setForeground(Color.green);
